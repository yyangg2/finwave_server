...
public class InitDb {
    ...
    static class InitService {
        ...
        public void dbInit0() {
            ...
            //리뷰 작성
            ReviewMentee reviewMentee1 = ReviewMentee.createReviewMentee(mentee1, mentor1, 5, "멘토님과 함께한 멘토링 수업은 정말로 유익하고 인상적이었습니다. 멘토님은 금융 분야에 대한 깊은 지식을 바탕으로 재테크와 투자에 대한 현실적인 조언을 제공해 주셨습니다. 특히, 목표 지향적인 성향을 가진 저에게 맞춤형 조언을 해주셔서 미래의 재무적 안정성을 구축하는 데 큰 도움이 되었습니다. 멘토님의 열정과 실용적인 접근 방식은 매우 감명깊었고, 이제 더 나은 금융적인 결정을 내릴 수 있게 되었습니다.", LocalDateTime.now());
            em.persist(reviewMentee1);
            ReviewMentee reviewMentee2 = ReviewMentee.createReviewMentee(mentee1, mentor2, 5, "멘토님과 함께한 멘토링 수업은 정말로 유익하고 인상적이었습니다. 멘토님은 금융 분야에 대한 깊은 지식을 바탕으로 재테크와 투자에 대한 현실적인 조언을 제공해 주셨습니다. 특히, 목표 지향적인 성향을 가진 저에게 맞춤형 조언을 해주셔서 미래의 재무적 안정성을 구축하는 데 큰 도움이 되었습니다. 멘토님의 열정과 실용적인 접근 방식은 매우 감명깊었고, 이제 더 나은 금융적인 결정을 내릴 수 있게 되었습니다.", LocalDateTime.now());
        ...
        public void dbInit1() {
            Mentee mentee = createMentee("kau20@naver.com", "4444", "이혜인", "01044445555", Gender.WOMAN,
                    "주식", 22, "학생", 3, 1, 1, 1, "안녕하세요, 여러분! 저는 금융의 무한한 가능성을 탐험하는 여정에 도전하고 있는 이혜인입니다.\n" +
...
//            em.persist(menteeMentor);
        ...
        public void dbInit2() {
            Mentee mentee = createMentee("kau21@naver.com", "5555", "맹성주", "01055556666", Gender.MAN,
                    "대출", 26, "학생", 4, 2, 2, 4, "안녕하세요! 지식의 즐거움과 전문성 강화에 열중하는 맹성주입니다. 대학과 금융 분야에서의 탐험을 통해 나만의 진로를 발견하고 있는데요.\n" +
...
//            em.persist(menteeMentor);
        ...
        public void dbInit3() {
            Mentee mentee = createMentee("kau22@naver.com", "6666", "이진우", "01066667777", Gender.MAN,
                    "부동산", 27, "학생", 5, 3, 4, 3, "안녕하세요, 여러분! 저는 이진우라고 합니다. 현재 기업 금융과 투자 분야를 새롭게 탐험하고 있는 여행자입니다.\n" +
...
//            em.persist(menteeMentor);
        ...
        public void dbInit4() {
            Mentee mentee = createMentee("kau23@naver.com", "6666", "김춘자", "01066667777", Gender.WOMAN,
                    "부동산", 27, "학생", 5, 3, 4, 3, "안녕하세요! 저는 김춘자, 호기심 가득한 여행을 즐기며 끊임없이 새로운 것을 배우는 것에 즐거움을 느끼고 있어요.\n" +
